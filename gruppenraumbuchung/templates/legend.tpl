...
%optional logged_in%
<p class="status-legende" style="border-left: 14px solid #CCCCCC">%~room_marked_by_you%</p>
<p class="status-legende" style="border-left: 14px solid #999999">%~room_reserved_by_you%</p>
%/optional logged_in%
